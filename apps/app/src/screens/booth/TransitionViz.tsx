...
export function TransitionViz({ transition, progress }: TransitionVizProps) {
  ...
  return (
    <div className="panel flex flex-col items-center justify-center px-3 py-4">
      ...
      <div className="my-2 flex items-center gap-2">
        ...
        <div className="relative h-1 w-16 overflow-hidden rounded-full bg-ink-3">
          {active && (
            <div
              className="absolute inset-y-0 left-0 bg-energy"
      ...
      <span
        className={`font-display text-sm ${
          active ? "text-paper" : "text-mist/50"
        }`}
      >
